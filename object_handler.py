...
class ObjectHandler:
    def __init__(self, game):
        ...
        self.restricted_area = {(i, ) for i in range(10) for j in range(10)}
        self.spawn_npc()
    ...
    def update(self):
        ...
        print("NPCs:", len(self.npc_positions))
        print("Alive positions:", len(self.npc_positions))
